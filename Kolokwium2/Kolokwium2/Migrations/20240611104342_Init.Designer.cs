            ...
            modelBuilder.Entity("Kolokwium2.Models.CharacterTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CharacterId = 1,
                            TitleId = 1,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 43, 42, 55, DateTimeKind.Local).AddTicks(3769)
                        },
                        new
                        {
                            CharacterId = 1,
                            TitleId = 2,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 43, 42, 55, DateTimeKind.Local).AddTicks(3810)
                        },
                        new
                        {
                            CharacterId = 1,
                            TitleId = 3,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 43, 42, 55, DateTimeKind.Local).AddTicks(3812)
                        },
                        new
                        {
                            CharacterId = 2,
                            TitleId = 1,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 43, 42, 55, DateTimeKind.Local).AddTicks(3814)
                        },
                        new
                        {
                            CharacterId = 3,
                            TitleId = 2,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 43, 42, 55, DateTimeKind.Local).AddTicks(3816)
                        });
                });
