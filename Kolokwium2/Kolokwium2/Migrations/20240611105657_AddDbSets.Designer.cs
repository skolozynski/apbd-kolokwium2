...
namespace Kolokwium2.Migrations
{
    ...
    [Migration("20240611105657_AddDbSets")]
            ...
            modelBuilder.Entity("Kolokwium2.Models.CharacterTitle", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CharacterId = 1,
                            TitleId = 1,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 56, 57, 662, DateTimeKind.Local).AddTicks(3439)
                        },
                        new
                        {
                            CharacterId = 1,
                            TitleId = 2,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 56, 57, 662, DateTimeKind.Local).AddTicks(3483)
                        },
                        new
                        {
                            CharacterId = 1,
                            TitleId = 3,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 56, 57, 662, DateTimeKind.Local).AddTicks(3485)
                        },
                        new
                        {
                            CharacterId = 2,
                            TitleId = 1,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 56, 57, 662, DateTimeKind.Local).AddTicks(3487)
                        },
                        new
                        {
                            CharacterId = 3,
                            TitleId = 2,
                            AcquiredAt = new DateTime(2024, 6, 11, 12, 56, 57, 662, DateTimeKind.Local).AddTicks(3489)
                        });
                });
